...
<nav class="navbar bg-body-tertiary navbar-dark bg-dark" id='navbar'>
  <div class="container-fluid" id='container'>
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="createT" id='create'>Creat Design</a>
        </li> 
    </ul>
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="offersT" id='pattern'>Offers</a>
        </li>
    </ul>
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="viewOffersT">Given Offers</a>
        </li>
    </ul>
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="pendingOrderT">Pending Orders</a>
        </li>
    </ul>
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="orderHistoryT">Order History</a>
        </li>
    </ul>
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
    ...
    <div class="dropdown open">
        ...
        <div class="dropdown-menu bg-light" aria-labelledby="triggerId">     
            <b4-link class="dropdown-item">
                <a href="manageT">Manage Account</a>
            </b4-link>
            <b4-link class="dropdown-item">
