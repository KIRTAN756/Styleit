...
@extends('home')
@section('content')
<form method='post' action='/updtProfile'>
    @csrf
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td> 
                                <div class="form-group">
                                  ...
                                  <input type="text"
                                    class="form-control" name="fname" id='fname' disabled placeholder="Kirtan" value="{{$d->U_Name}}">
                                </div>
                            </td>
                            <td> 
                                <div class="form-group">
                                  ...
                                  <input type="email"
                                    class="form-control" name="email" id='email' disabled placeholder="something@gmail.com" value="{{$d->U_Email}}">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="text"
                                    class="form-control" pattern=[0-9]{10} name="mobno" id="mobno" maxlength="10" disabled placeholder="Mobile Number" value="{{$d->U_MobileNo}}">
                                </div>
                            </td>
                        </tr>
                        @endforeach
                        ...
                        <tr>
                            ...
                            <td align='right'>
                                <b4-link>
                                    <a href="delAddress?id={{$d1->Address_id}}" onclick="return confirm('Are you sure you want to Delete?')">Delete</a>
                                </b4-link>
                            </td>
                        </tr>
                        <tr>
        ...
        <tr>
            ...
            <td> 
                <div class="form-group">
                  ...
                  <input type="text"
                    class="form-control" name="uname" id='uname' disabled placeholder="Username" value="{{$d->U_userName}}">
                </div>
            </td>
            @endforeach
            <td align='center' class="form-group">
                <b4-link>
                    <a href="change" style="font-size: 30px;">Change Password</a>
                </b4-link>
            </td>
        </tr>
        <tr>
